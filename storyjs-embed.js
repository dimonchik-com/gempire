...
function createStoryJS(c, src) {
    ...
    function buildEmbed() {
        ...
        setTimeout(function(){
            ...
            var timeline_config_two = {
              width:              '100%',
              source:             'https://raw.githubusercontent.com/dimonchik-com/irespons/master/example_json_month.json',
              embed_id:           'timeline_two',               //OPTIONAL USE A DIFFERENT DIV ID FOR EMBED
              ...
              lang:               'ru',                           //OPTIONAL LANGUAGE
              maptype:            'watercolor',
              js:"js/timeline-min.js?2.24",
              css:"css/timeline.css?2.24",
              height:"100%"
            }

            var styletoryjs_embedjs_two = new VMM.Timeline("storyjs-timeline_two");
            styletoryjs_embedjs_two.init(timeline_config_two);  
